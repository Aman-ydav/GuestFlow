...
export function RegistrationForm({ onRegistered }) {
  ...
  return (
    <form onSubmit={handleSubmit} noValidate className="space-y-6">
      {/* Fields take 2/3 of the width, photo panel sits alongside on its own third —
          makes real use of the full-width card instead of stretching short inputs
          across the whole row (see Aman: "use the full width for the visitor reg form"). */}
      <div className="grid gap-6 lg:grid-cols-3">
        <div className="grid gap-4 sm:grid-cols-2 lg:col-span-2 lg:self-start">
